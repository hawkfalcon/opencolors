...
t('desktop header is a centered island', /min-width:721px\)\{\s*header\{[^}]*width:fit-content;[^}]*margin-inline:auto;[^}]*justify-content:center/.test(css));
t('no auto-margin split in header', !/\.header-name\{[^}]*margin-right:auto/.test(css) && !/\.header-name\{margin-right:0\}/.test(css));
